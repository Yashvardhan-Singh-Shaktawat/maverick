...
export default function CrmImplementation({ onBackToHome }) {
  ...
  const pillars = [
    {
      ...
      name: 'CRM Architecture & Setup',
      fullName: 'Enterprise CRM Setup & Pipeline Architecture',
      icon: Users2,
      color: '#00A8CC',
      description: 'Architect a custom CRM ecosystem tailored to your unique sales cycle, team hierarchy, and deal stages across HubSpot, Salesforce, or Zoho.',
      timeline: '3 - 6 Weeks',
      deliverables: [
        'Custom lifecycle stage and deal pipeline blueprinting',
        'Role-based permissions, team territory assignment, and security policies',
        'Custom properties, object associations, and layout configuration',
        'Executive sales forecast dashboard and reporting view setup'
      ],
      suitableFor: 'Scaling sales teams needing structured deal tracking and clean data hygiene.'
    },
    {
      id: 'data-migration',
      badge: 'CLEAN DATA',
      name: 'Data Migration & Hygiene',
      fullName: 'Legacy Data Migration & Deduplication Framework',
      icon: Database,
      color: '#3B82F6',
      description: 'Safely extract, clean, deduplicate, and migrate historic lead and customer records from spreadsheets or legacy software with zero data loss.',
      timeline: '2 - 4 Weeks',
      deliverables: [
        'Legacy database audit, field mapping, and data normalization',
        'Automated deduplication and obsolete record archiving',
        'Historical activity and communication history migration',
        'Pre/post-migration data validation and audit integrity certification'
      ],
      suitableFor: 'Businesses transitioning from legacy CRMs, spreadsheets, or disparate tools.'
    },
    {
      id: 'automation-workflows',
      badge: 'AUTOMATION',
      name: 'Automated Workflows & Triggers',
      fullName: 'Automated Sales Workflows & SLA Lead Routing',
      icon: Zap,
      color: '#10B981',
      description: 'Automate repetitive manual tasks, enforce strict lead response SLAs, and trigger intelligent email follow-ups based on real-time buyer engagement.',
      timeline: '2 - 5 Weeks',
      deliverables: [
        'Speed-to-lead instant routing workflows and rep round-robin assignment',
        'Deal stage progression triggers and automated stale-deal alerts',
        'Task creation, reminder automation, and meeting scheduler integration',
        'Automated re-engagement sequences for cold or closed-lost accounts'
      ],
      suitableFor: 'Teams looking to eliminate administrative drag and boost rep selling time.'
    },
    {
      id: 'integrations-onboarding',
      badge: 'INTEGRATIONS & TRAINING',
      name: 'Ecosystem Integrations & Training',
      fullName: 'Tech Stack Integrations & Hands-On Team Enablement',
      icon: Layers,
      color: '#8B5CF6',
      description: 'Connect your CRM with billing, marketing automation, telephony, and ERP software, coupled with hands-on training to ensure 100% rep adoption.',
      timeline: '2 - 4 Weeks',
      deliverables: [
        'Stripe, QuickBooks, Slack, Teams, and email bi-directional sync',
        'Marketing automation, website form, and telephony API webhooks',
        'Role-specific interactive live training workshops and video playbooks',
        '30-day post-launch hypercare support and rep adoption tracking'
      ],
      suitableFor: 'Companies ensuring seamless cross-department tool synergy and rapid user adoption.'
    }
  ]
      ...
      <div className="bg-gradient-to-b from-white to-[#F8FAFC] border-b border-slate-200/80 pt-10 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 text-xs sm:text-sm text-slate-500 mb-8 font-medium">
            ...
            <span>/</span>
            <span className="text-[#00A8CC] font-bold">CRM Implementation</span>
          </div>
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base sm:text-lg text-slate-600 leading-relaxed font-normal">
              End-to-end architectural implementation and team onboarding for your CRM ecosystem. We transform messy pipelines into streamlined revenue machines across HubSpot, Salesforce, and Zoho.
            </p>
          </div>
      ...
      <div className="bg-[#00A8CC] text-white py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/15 text-white border border-white/20 text-xs sm:text-[13px] font-extrabold tracking-widest uppercase mb-4 shadow-sm">
            ...
            REINVENT YOUR SALES WORKFLOW
          </div>
          
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-tight mb-4">
            Transform Your CRM Into a Revenue Growth Machine
          </h2>
          
          <p className="text-white/90 text-sm sm:text-base max-w-2xl mx-auto mb-9 leading-relaxed font-normal">
            Equip your sales, marketing, and operations teams with clean data, automated workflows, and reliable pipeline clarity.
          </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-md animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 sm:p-9 shadow-2xl border border-slate-100 relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
              ...
              >
                <span>Request CRM Setup Consultation</span>
